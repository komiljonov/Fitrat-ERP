...
class Homework(BaseModel):
    theme: "Theme" = models.ForeignKey(
        "subject.Theme", on_delete=models.CASCADE, related_name="themes_homework"
    )
    title = models.TextField()
    body = models.TextField()
    video: "File" = models.ManyToManyField(
        "upload.File", blank=True, related_name="homeworks_video"
    )
    documents: "File" = models.ManyToManyField(
        "upload.File", blank=True, related_name="homework_documents"
    )
    photo: "File" = models.ManyToManyField(
        "upload.File", blank=True, related_name="homework_photo"
    )
...
class Homework_history(BaseModel):
    ...
    updater: "CustomUser" = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="homeworks_updater",
    )
