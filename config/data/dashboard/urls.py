...
from data.dashboard.views import (
    DashboardView,
    MarketingChannels,
    CheckRoomFillingView,
    DashboardLineGraphAPIView,
    DashboardWeeklyFinanceAPIView,
    ArchivedView,
    MonitoringExcelExportView,
    SalesApiView,
    FinanceStatisticsApiView,
    StudentLanguage,
    ExportDashboardToExcelAPIView,
    AdminLineGraph,
    DashboardSecondView,
    MonitoringAsosAPIView,
)
...
urlpatterns = [
    ...
    path(
        "room-filling/",
        CheckRoomFillingView.as_view(),
        name="check-room-lesson-schedule",
    ),
    path("finance/", DashboardLineGraphAPIView.as_view(), name="dashboard-line-graph"),
    path("monitoring/", MonitoringAsosAPIView.as_view(), name="monitoring"),
    path(
        "monitoring/excel", MonitoringExcelExportView.as_view(), name="monitoring-excel"
    ),
    ...
    path(
        "finance-kind/", FinanceStatisticsApiView.as_view(), name="finance-statistics"
    ),
    path("student-lang/", StudentLanguage.as_view(), name="student-lang"),
    path(
        "finance-excel/", ExportDashboardToExcelAPIView.as_view(), name="finance-excel"
    ),
