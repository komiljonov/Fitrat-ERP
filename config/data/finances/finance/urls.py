...
from .views import (
    ...
    CasherListCreateAPIView,
    CasherRetrieveUpdateDestroyAPIView,
    CasherHandoverAPIView,
    FinanceStatisticsAPIView,
    CasherNoPg,
    CasherHandoverHistory,
    CasherStatisticsAPIView,
