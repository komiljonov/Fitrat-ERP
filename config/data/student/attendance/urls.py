...
urlpatterns = [
    ...
    path(
        "sec-group/<uuid:pk>/",
        LessonSecondaryAttendanceList.as_view(),
        name="lesson-secondary-list",
    ),
    path("bulk/", AttendanceBulkList.as_view(), name="bulk-attendance-list"),
    path(
        "bulk/update",
        AttendanceBulkUpdateAPIView.as_view(),
        name="bulk-update-attendance-list",
    ),
    path(
        "secondary/",
        SecondaryAttendanceList.as_view(),
        name="secondary-attendance-list",
    ),
    path(
        "secondary/<uuid:pk>",
        SecondaryAttendanceDetail.as_view(),
        name="secondary-attendance-detail",
    ),
    path(
        "secondary/bulk",
        SecondaryAttendanceBulkUpdateView.as_view(),
        name="secondary-bulk-update-attendance-list",
    ),
