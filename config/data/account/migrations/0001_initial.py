    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_user', models.CharField(blank=True, max_length=100, null=True, unique=True)),
