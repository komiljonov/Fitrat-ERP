...
class Asos4ListCreateView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = ResultSubjects.objects.filter(archived_at=None)
...
class ResultsNameListCreateView(ListCreateAPIView):
    queryset = ResultName.objects.filter(archived_at=None)
    ...
    def get_queryset(self):
        ...
        return ResultName.objects.filter(archived_at=None)
