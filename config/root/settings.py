...
REST_FRAMEWORK = {
    ...
    "DEFAULT_RENDERER_CLASSES": [
        ...
        "command.renderers.NoFormBrowsableAPIRenderer",  # use the class from Option A
    ],
...
CLICK_COMMISSION_PERCENT = (
    "(optional int field) your companies comission percent if applicable"
)
