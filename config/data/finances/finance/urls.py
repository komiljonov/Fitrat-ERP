...
from .views import (
    ...
    FinanceNoPGList,
    StudentFinanceListAPIView,
    StuffFinanceListAPIView,
    CashierListCreateAPIView,
    CashierRetrieveUpdateDestroyAPIView,
    CasherHandoverAPIView,
    FinanceStatisticsAPIView,
    CashierNoPg,
    CasherHandoverHistory,
    CashierStatisticsAPIView,
    ...
    PaymentMethodsList,
    PaymentStatistics,
    PaymentCasherStatistics,
    SalesList,
    SalesStudentList,
    SalesStudentsRetrieve,
    PaymentStatisticsByKind,
    SalesStudentNoPG,
    GeneratePaymentExcelAPIView,
    SaleStudentRetrieve,
    VoucherList,
    VoucherRetrieve,
    VoucherNoPG,
    VoucherStudentRetrieve,
    VoucherStudentList,
    FinancePaymentMethodsAmountsListAPIView,
)
...
urlpatterns = [
    ...
    path(
        "student/<uuid:pk>/",
        StudentFinanceListAPIView.as_view(),
        name="finance_student",
    ),
    path("stuff/<uuid:pk>/", StuffFinanceListAPIView.as_view(), name="finance_stuff"),
    path("casher/", CashierListCreateAPIView.as_view(), name="finance_casher"),
    path(
        "casher/<uuid:pk>/",
        CashierRetrieveUpdateDestroyAPIView.as_view(),
        name="finance_casher",
    ),
    path("casher/no-pg/", CashierNoPg.as_view(), name="finance_casher_no-pg"),
    path(
        "casher/stats/<uuid:pk>/",
        CashierStatisticsAPIView.as_view(),
        name="finance_casher_stats",
    ),
    path(
        "method-amount/",
        FinancePaymentMethodsAmountsListAPIView.as_view(),
        name="finance_payment_method_amounts",
    ),
    path("handover", CasherHandoverAPIView.as_view(), name="finance_handover"),
    path(
        "handover/<uuid:pk>/",
        CasherHandoverHistory.as_view(),
        name="finance_handover_history",
    ),
    path("statistics/", FinanceStatisticsAPIView.as_view(), name="finance_statistics"),
    path(
        "teacher/<uuid:pk>/",
        TeacherGroupFinanceAPIView.as_view(),
        name="finance_teacher",
    ),
    ...
    path(
        "payment_casher/<uuid:pk>",
        PaymentCasherStatistics.as_view(),
        name="payment_casher",
    ),
    ...
    path(
        "sale/student/<uuid:pk>/", SalesStudentsRetrieve.as_view(), name="sale_student"
    ),
    path("payment-reason/", PaymentStatisticsByKind.as_view(), name="payment_kind"),
    path(
        "finance/casher/excel/",
        GeneratePaymentExcelAPIView.as_view(),
        name="finance_casher_excel",
    ),
