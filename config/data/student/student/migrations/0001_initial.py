    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(default=datetime.datetime(2025, 1, 17, 21, 40, 57, 848661))),
                ...
                ('moderator', models.ForeignKey(blank=True, help_text='Moderator for this student', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_moderator', to=settings.AUTH_USER_MODEL)),
