    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(blank=True, null=True, related_name='account_files', to='upload.file')),
                ('filial', models.ManyToManyField(to='filial.filial')),
