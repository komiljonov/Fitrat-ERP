...
class Compensation(BaseModel):
    name = models.CharField(
        choices=[
            (
                "Sinov darsiga yozilib kelmaganlar uchun jarima",
                "Sinov darsiga yozilib kelmaganlar uchun jarima",
            ),
            (
                "Sinov darsiga keldi lekin aktivga o‘tmaganligi uchun jarima",
                "Sinov darsiga keldi lekin aktivga o‘tmaganligi uchun jarima",
            ),
            (
                "Aktivdan ketgan o‘quvchi uchun jarima",
                "Aktivdan ketgan o‘quvchi uchun jarima",
            ),
            (
                "Jami qarzdor o‘quvchilar sonining 80.1% dan 85% gacha bo‘lgan qismi uchun jarima",
                "Jami qarzdor o‘quvchilar sonining 80.1% dan 85% gacha bo‘lgan qismi uchun jarima",
            ),
            (
                "Jami qarzdor o‘quvchilar sonining 70% dan 80% gacha bo‘lgan qismi uchun jarima",
                "Jami qarzdor o‘quvchilar sonining 70% dan 80% gacha bo‘lgan qismi uchun jarima",
            ),
            (
                "Jami qarzdor o‘quvchilar sonining 69.9% dan kichik bo‘lgan qismi uchu jarima",
                "Jami qarzdor o‘quvchilar sonining 69.9% dan kichik bo‘lgan qismi uchu jarima",
            ),
        ],
        max_length=256,
...
class Bonus(BaseModel):
    name = models.CharField(
        choices=[
            ...
            (
                "Bir oyda 10 marta kelgan har bir o‘quvchi uchun bonus",
                "Bir oyda 10 marta kelgan har bir o‘quvchi uchun bonus",
            ),
            (
                "O‘quvchi to‘lagan summadan foiz beriladi",
                "O‘quvchi to‘lagan summadan foiz beriladi",
            ),
        ],
        max_length=256,
...
class Comments(BaseModel):
    asos: "Asos" = models.ForeignKey(
        "compensation.Asos", on_delete=models.CASCADE, related_name="asos4_comments"
    )
    ...
    monitoring: "Monitoring" = models.ForeignKey(
...
class Monitoring(BaseModel):
    ...
    user: "CustomUser" = models.ForeignKey(
        "account.CustomUser", on_delete=models.CASCADE, related_name="user_monitoring"
    )
    point: "Point" = models.ForeignKey(
        "compensation.Point", on_delete=models.CASCADE, related_name="point_monitoring"
    )
...
class ResultName(BaseModel):
    ...
    point_type = models.CharField(
        choices=[("Percentage", "Percentage"), ("Ball", "Ball"), ("Degree", "Degree")],
        max_length=10,
    )
...
class ResultSubjects(BaseModel):
    asos: "Asos" = models.ForeignKey("compensation.Asos", on_delete=models.CASCADE)
    result: "ResultName" = models.ForeignKey(
        "compensation.ResultName", on_delete=models.SET_NULL, null=True, blank=True
    )
    name = models.CharField(max_length=256)
...
class MonitoringAsos4(BaseModel):
    asos = models.ForeignKey(
        "compensation.Asos", on_delete=models.SET_NULL, null=True, blank=True
    )
    creator: "CustomUser" = models.ForeignKey(
        "account.CustomUser",
        on_delete=models.SET_NULL,
    ...
    subject = models.ForeignKey(
        "compensation.ResultSubjects", on_delete=models.SET_NULL, null=True, blank=True
    )
...
class StudentCountMonitoring(BaseModel):
    ...
    teacher = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="student_count_monitoring_teacher",
    )
...
class StudentCatchingMonitoring(BaseModel):
    ...
    teacher: "CustomUser" = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="StudentCatchingMonitoring_teacher",
    )
    name = models.CharField(max_length=256)
