...
class Results(BaseModel):
    ...
    teacher: "CustomUser" = models.ForeignKey(
        "account.CustomUser", on_delete=models.CASCADE, related_name="teacher_results"
    )
    ...
    national = models.ForeignKey(
        "subject.Subject",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="national_results",
    ...
    university_entering_type = models.CharField(
        choices=[("Grant", "Grant"), ("Kontrakt", "Kontrakt")],
        max_length=100,
        null=True,
        blank=True,
    )
    ...
    # )
    result_fk_name: "ResultName" = models.ForeignKey(
        "compensation.ResultName",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="monitoring_result_name",
    )
