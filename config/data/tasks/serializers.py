...
class TaskSerializer(serializers.ModelSerializer):
        ...
        if filial is None and performer:
            ...
            if performer_filials.exists():
                ...
                raise serializers.ValidationError(
                    {"filial": "Filial is required but cannot be determined."}
                )
    ...
    def to_representation(self, instance):
        ...
        representation["performer"] = {
            ...
            "photo": (
                instance.performer.photo.url
                if instance.performer and instance.performer.photo
                else None
            ),
        }
        ...
        representation["file"] = (
            FileUploadSerializer(instance.file, context=self.context).data
            if instance.file
            else None
        )
