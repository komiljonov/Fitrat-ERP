...
from .views import (
    ...
    RoomNoPG,
    SecondaryGroupsView,
    SecondaryGroupRetrieveUpdateDestroyAPIView,
    SecondaryNoPG,
    DaysNoPG,
    DaysAPIView,
    LessonScheduleListApi,
    GroupLessonScheduleView,
    LessonScheduleWebListApi,
    RoomFilterView,
    CheckRoomLessonScheduleView,
    GroupIsActiveNowAPIView,
    SecondaryGroupIsActiveNowAPIView,
    StudentGroupIsActiveNowAPIView,
...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/", GroupRetrieveUpdateDestroyAPIView.as_view(), name="group-detail"
    ),
    ...
    path(
        "schedule-extra/",
        ExtraLessonScheduleView.as_view(),
        name="extra-lesson-schedule",
    ),
    path(
        "<uuid:pk>/schedule/", GroupLessonScheduleView.as_view(), name="group-schedule"
    ),
    path(
        "room-check/",
    ...
    path(
        ...
        name="check-group-is-active",
    ),
    path(
        "check/secondary/<uuid:pk>",
        SecondaryGroupIsActiveNowAPIView.as_view(),
        name="check-secondary-group-is-active",
    ),
    path(
        "check/student/<uuid:pk>",
        StudentGroupIsActiveNowAPIView.as_view(),
        name="student-groups",
    ),
    ...
    path(
        "secondary/<uuid:pk>/",
        SecondaryGroupRetrieveUpdateDestroyAPIView.as_view(),
    ...
    path(
        "group-sale/",
        StudentSaleGroupListCreateAPIView.as_view(),
        name="group-sale-list",
    ),
    path(
        "group-sale/<uuid:pk>",
        StudentSaleGroupDetailAPIView.as_view(),
        name="group-sale-detail",
    ),
]
