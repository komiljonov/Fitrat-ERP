...
class Question(BaseModel):
    ...
    text: "QuizGaps" = models.ForeignKey(
        "quiz.QuizGaps",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="questions_gaps",
    )
    answers: "Answer" = models.ManyToManyField(
        "quiz.Answer", related_name="questions_answers"
    )
...
class Fill_gaps(BaseModel):
    ...
    question: "QuizGaps" = models.ForeignKey(
        "quiz.QuizGaps",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
...
class MatchPairs(BaseModel):
    ...
    pairs: "Pairs" = models.ManyToManyField(
        "quiz.Pairs", related_name="match_pairs_pair"
    )
...
class Cloze_Test(BaseModel):
    ...
    questions: "QuizGaps" = models.ManyToManyField(
        "quiz.QuizGaps", related_name="cloze_questions"
    )
    sentence: "Answer" = models.ForeignKey(
        "quiz.Answer",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
...
class ExamSubject(BaseModel):
    ...
    certificate: "File" = models.ForeignKey(
        "upload.File",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
...
class Exam(BaseModel):
    ...
    students_xml = models.ForeignKey(
        "upload.File",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    ...
    options: "ExamSubject" = models.ManyToManyField(
        "quiz.ExamSubject", related_name="exam_subject_options"
    )
...
class ExamRegistration(BaseModel):
    ...
    option: "ExamSubject" = models.ManyToManyField(
        "quiz.ExamSubject", related_name="registration_option_subjects"
    )
