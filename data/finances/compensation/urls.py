...
from .views import (
    ...
    ResultsNameListCreateView,
    AsosListRetrieveView,
    AsosNoPGListView,
    MonitoringBulkCreateView,
    MonitoringRetrieveView,
    PointListCreateView,
    PointRetrieveView,
    PointNoPGListView,
    MonitoringListCreateView,
    Asos4ListCreateView,
    ResultSubjectRetrieveView,
    StudentCountMonitoringListCreateView,
    MonitoringAsosListCreateView,
    CommentsListCreateView,
    Monitoring5List,
    MonitoringAsos_1_2List,
    MonitoringAsos_1_2Update,
    UserMonitoringAsos1_2,
